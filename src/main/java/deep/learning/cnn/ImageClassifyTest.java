...
public class ImageClassifyTest {
	...
	public void run(String[] args) throws Exception {
		...
		FileSplit fileSplit = new FileSplit(new File("datafashion\\images-resize\\Number"),
		...
		network = network.load(new File("datafashion\\models\\model-alexnet-combined-graph-128-100-correctedheight.bin"), false);
...
//		enableCuda();
		new ImageClassifyTest().run(args);
