...
//    protected static int width = 136;
    ...
    public void run(String[] args) throws Exception {
        ...
        File mainPath = new File("datafashion\\images-resize-240-320\\Number\\train");
...
//        MultiLayerNetwork network = new AlexNet(height, width, channels, numLabels, seed, 1000).init();
       ...
       // network.setListeners(new ScoreIterationListener(listenerFreq));
        ...
        if (save) {
            log.info("Save model....");
            ModelSerializer.writeModel(network, "datafashion\\models\\model-alexnet-number.bin", true);
        }
